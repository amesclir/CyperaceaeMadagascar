...
resDEC$inputs$num_cores_to_use = 8
resDEC$inputs$geogfn = "CyperaceaeMadagascar_occurrence_world.txt"
resDEC$inputs$trfn = "tree.tree"
...
pdffn = paste0("Cyperaceae_", model_name, "_v1.pdf")
pdf(pdffn, width=9, height=36)

analysis_titletxt = paste0(model_name, " on Cyperaceae")
...
pdf(file=pdffn, width=12, height=64)
